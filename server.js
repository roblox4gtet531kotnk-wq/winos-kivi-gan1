  ...
  try {
    ...
    const response = await fetch('https://llm.api.cloud.yandex.net/foundationModels/v1/completion', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {role: 'system', text: 'Ты лучший помощник игры KIWI GUN. Отвечай на русском длинно и с эмодзи, ты создан данилом-данил владелец и лучший програмист, ты всё занаеш про киви ган- это 3д шутер.'},
